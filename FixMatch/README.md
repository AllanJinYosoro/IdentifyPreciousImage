...
```
# python Mytrain.py --num-workers 4 --dataset PhotoGraph --batch-size 9 --num-labeled 45 --eval-step 4  --arch wideresnet  --lr 0.03 --expand-labels --seed 5 --out results/local_test
```
### Requirements
- python 3.6+
- torch 1.4
