...
def create_and_remove(pending_label_images,ulb_num,test_num):
    # 定义rawdata目录
...
def import_picture(route,ulb_num,test_num):
    create_and_remove(route,ulb_num,test_num)
    cluster_N_unique_image('./data/rawdata/ulb')
